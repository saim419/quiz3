...
const APIdemo = () => {
    ...
    return (
        <SafeAreaView style={{ flex: 1, fontSize: 24, margin: 30 }}>
            <Text>API Demo</Text>
            <Text style={{ marginTop: 30 }}>Give a word you like: </Text>
            <TextInput
            ...
            <Button
                onPress={() => { setLoading(true); setData({ choices: [] }); setPrompt('give a saracastic definition for the word: ' + promptText); }}
